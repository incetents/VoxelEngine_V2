...
//
//		// FBO
//		GlobalRenderText.m_FBO->SetClearColor(Color4F(1, 1, 0, 1));
...
//
//		// Generate render texture information
...
//		//	m_mesh = Mesh::Create();
//		//	
//		//	float h_width = (renderText.m_renderTexture->GetWidth() / 400.0f) * 0.5f;
//		//	float h_height = (renderText.m_renderTexture->GetHeight() / 400.0f) * 0.5f;
//		//	
//		//	Vector3 pos[] = {
